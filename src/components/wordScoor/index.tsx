  ...
  return (
    <div className={styles.word_scoor}>
      ...
      <div className={styles.word_scoor_bar}>
        ...
        <div
          className={
            wordPoint > 9 && wordPoint < 20 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 19 && wordPoint < 30 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 29 && wordPoint < 40 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 39 && wordPoint < 50 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 49 && wordPoint < 60 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 59 && wordPoint < 70 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 69 && wordPoint < 80 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 79 && wordPoint < 90 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
        ...
        <div
          className={
            wordPoint > 89 && wordPoint < 100 ? styles.word_scoor_bar_point : ""
          }
        >
          <div className={styles.word_scoor_bar_point_inside}>
